...
#		cat ("\n-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--\n")
			...
			png (filename = paste0(names(hp_2015[i]), "_%02d.png"), width = 1920, height = 960)
			par (mfrow = c (1, 3))
...
# ... corruption data transform
	...
	i <- 11
			...
			png (filename = paste0("log_", names(hp_2015[i]), "_%02d.png"), width = 1920, height = 960)
			par (mfrow = c (1, 3))
...
# ... generostiy data transform
	...
	i <- 12
			png (filename = paste0("_", names(hp_2015[i]), "_%02d.png"), width = 1920, height = 960)
			par (mfrow = c (1, 3))
